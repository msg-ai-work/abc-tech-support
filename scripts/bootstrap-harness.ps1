...
$required = @("$Dest/HARNESS.md", "$Dest/.kiro/steering", "$Dest/.kiro/skills", ".kiro/agents/enterprise-messaging-tech-support.json")
...
Write-Host "Kiro Agent: enterprise-messaging-tech-support"
